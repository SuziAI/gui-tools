...
<img src="annotation_tool_tutorial/1.png|width=100" width="100">
...
![](annotation_tool_tutorial/2.png|width=100)
...
![](annotation_tool_tutorial/5.png|width=100)

Using the button `New Segmentation` in the `Main Window`, ...

![](annotation_tool_tutorial/6.png|width=100)
...
![](annotation_tool_tutorial/7.png|width=100)

Therefore, select `Delete` in the `Main Window`.

![](annotation_tool_tutorial/8.png|width=100)
...
![](annotation_tool_tutorial/9.png|width=100)
...
![](annotation_tool_tutorial/10.png|width=100)

In the `Main Window`, choose the button `Create`.

![](annotation_tool_tutorial/11.png|width=100)
...
![](annotation_tool_tutorial/12.png|width=100)

In the `Main Window`, choose the button `Mark`, and choose the type label button `Title`.

![](annotation_tool_tutorial/13.png|width=100)
...
![](annotation_tool_tutorial/14.png|width=100)
...
![](annotation_tool_tutorial/17.png|width=100)
...
![](annotation_tool_tutorial/18.png|width=100)

Fill in the character "鬲".

![](annotation_tool_tutorial/18_2.png|width=100)
...
![](annotation_tool_tutorial/19.png|width=100)
...
![](annotation_tool_tutorial/22.png|width=100)

When annotating the 19th *suzipu* character, assume that the upper part of this pair-character notation
is not *Gou* ![](../res/suzipu_notation/gou.png|width=100), but instead a misprint of *He* ![](../res/suzipu_notation/he.png|width=100).
Annotate as such, and exclude the box from the
image dataset by marking the checkbox marked in red.

![](annotation_tool_tutorial/22_2.png|width=100)
...
![](annotation_tool_tutorial/23.png|width=100)
...
![](annotation_tool_tutorial/24.png|width=100)

... and choose the mode from the list, ...

![](annotation_tool_tutorial/25.png|width=100)
... or click on the `Custom Mode Picker` button to create a custom mode, ...

![](annotation_tool_tutorial/26.png|width=100)
...
![](annotation_tool_tutorial/27.png|width=100)
...
![](annotation_tool_tutorial/28.png|width=100)
...
*jianpu* 简谱 notation, and *He* ![](../res/suzipu_notation/he.png|width=100) is rendered as **•1**
...
![](../res/suzipu_notation/add_dadun.png|width=100), ![](../res/suzipu_notation/add_xiaozhu.png|width=100), and
![](../res/suzipu_notation/add_dazhu.png|width=100) respectively.

![](annotation_tool_tutorial/29.png|width=100)

Using the dropdown menu marked in red, another fingering can be used, e.g., such that *He*
![](../res/suzipu_notation/he.png|width=100) is rendered as **•6**.

![](annotation_tool_tutorial/30.png|width=100)

When clicking at the five-line notation button, the score is on-the-fly rendered to appear as five-line notation.

![](annotation_tool_tutorial/31.png|width=100)

Using the button `Export Notation as Image`, ....

![](annotation_tool_tutorial/32.png|width=100)
...
![](annotation_tool_tutorial/32_2.png|width=100)

With the button `Export Notation as MusicXML`, ...

![](annotation_tool_tutorial/32_3.png|width=100)
...
![](annotation_tool_tutorial/33.png|width=100)

When clicking on the button `Export as Text`, ...

![](annotation_tool_tutorial/34.png|width=100)
